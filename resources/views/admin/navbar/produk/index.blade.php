    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <section class="content-area">
                <h1 class="header-title">Produk Geng Motor Bozzz</h1>
                <br>
                <div class="container">
                    <div class="row">
                        <!-- Card 1 -->
                        <div class="col-md-6 col-lg-4">
                            <div class="card" style="width: 100%;">
                                <img src="{{ asset('img/bj.png') }}" class="card-img-top" alt="Baju">
                                <div class="card-body">
                                    <h5 class="card-title" style="color :#1c1e26;">Baju</h5>
                                    <p class="card-text" style="color :#1c1e26;">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card" style="width: 100%;">
                                <img src="{{ asset('img/helm.png') }}" class="card-img-top" alt="Helm">
                                <div class="card-body">
                                    <h5 class="card-title" style="color :#1c1e26;">Helm</h5>
                                    <p class="card-text" style="color :#1c1e26;">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <a href="#" class="btn btn-primary">Go somewhere</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card" style="width: 100%;">
                                <img src="{{ asset('img/srg.png') }}" class="card-img-top" alt="Helm">
                                <div class="card-body">
                                    <h5 class="card-title" style="color :#1c1e26;">Sarung Tangan</h5>
                                    <p class="card-text" style="color :#1c1e26;">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <a href="#" class="btn btn-primary">Go somewhere</a>
                                </div>
                            </div>
