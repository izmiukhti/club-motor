    ...
    <div class="container">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('users.dashboard') }}">Home</a>
                    </li>
                    <li class="nav-item">
        ...
        <main class="main-content">
            ...
            <nav class="top-nav">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('users.navbar.profil') }}">Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('users.navbar.visimisi') }}">Visi Misi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('users.navbar.produk.index') }}">Produk</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('users.navbar.about') }}">About</a>
                    </li>
                </ul>
            </nav>
